...
export const getExpensesByBudget = async (budgetId) => {
  try {
    console.log('Demande de récupération des dépenses pour le budget ID:', budgetId);
    ...
    console.log('Réponse de récupération des dépenses:', response.data);
    return response.data;
  } catch (error) {
...
export const createTransactions = async (budgetId, transactions) => {
  try {
    console.log('Demande d\'ajout de transactions:', { budgetId, transactions });
    ...
    console.log('Réponse d\'ajout de transactions:', response.data);
    return response.data;
  } catch (error) {
    console.error('Erreur lors de l\'ajout des transactions:', error.response ? error.response.data : error.message);
    throw error.response ? error.response.data : error.message;
  }
};
